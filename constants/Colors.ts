/**
 * Colors - TypeScript Version
 * 
 * Design system color palette for the Luxe app.
 * All colors are typed as strings for type safety.
 */
...
export interface ColorsType {
  ...
  chipBackgroundText: string;
  
  // Navigation
  tabBackground: string;
  inActiveNavButtonBackground: string;
  
  // Special Purpose
  pastColor: string;
  iconClockBackground: string;
  iconAirplaneBackground: string;
  chipAbsenceBackground: string;
  chipVacationBackground: string;
...
// Elevation Levels
const elevation: ElevationLevels = {
  level0: 'transparent',
