...
const CustomHeader: React.FC<CustomHeaderProps> = ({ navigation: navProp, children, title }) => {
  ...
  const handleMenuPress = () => {
    if (isSideNavigation) {
      ...
      navigate('SideNavigation' as never);
    }
  };
    ...
    <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
      <View style={styles.header}>
        ...
        <View style={styles.right}>
          <TouchableOpacity onPress={() => navigate('WishlistScreen' as never)} style={styles.iconButton}>
            <Ionicons 
          ...
          <TouchableOpacity onPress={() => navigate('Search' as never)} style={styles.iconButton}>
