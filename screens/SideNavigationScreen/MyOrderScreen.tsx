        ...
        return (
            <CustomHeader navigation={navigation}>
                <EmptyListView
                    ...
                    actionLabel="Sign In"
                    onAction={() => navigation.navigate('AuthSignin' as never)}
                />
            </CustomHeader>
        );
    }
        ...
        return (
            <CustomHeader navigation={navigation}>
                <EmptyListView
                    ...
                    onAction={() => navigation.navigate('Main', { screen: 'HomeStack' } as any)}
                />
            </CustomHeader>
        );
    }
                    ...
                    <Surface key={order._id} elevation={2} margin={12} marginTop={12} padding={16}>
                        ...
                        <View style={styles.orderHeader}>
                            ...
                            <View style={[styles.statusBadge, { backgroundColor: getStatusColor(order.status) }]}>
                                <Ionicons name={getStatusIcon(order.status) as any} size={14} color={Colors.surface} />
