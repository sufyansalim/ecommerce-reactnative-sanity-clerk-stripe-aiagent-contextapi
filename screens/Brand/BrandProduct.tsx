...
interface BrandProductProps {
  ...
  route: RouteProp<any, 'BrandProduct'>;
}

const BrandProduct: React.FC<BrandProductProps> = ({ navigation, route }) => {
  const banner = route.params?.banner || "NO-Banner";
  const products = route.params?.products || [];
  
  const [brandProducts, setBrandProducts] = useState<Product[]>(products);
